...
public class MaxCarArrivalsApp {
    ...
    /**
     * Δημιουργούμε έναν δισδιαστατο πίνακα διπλάσιου μεγέθους που
     * στην πρώτη θέση έχει την ώρα και δίπλα αν είναι άφιξη (1) ή
     * αποχώρηση (0).
     * @param arr
     * @return
     */
    ...
    /**
     * Με το comparator επιλέγουμε βάσει ποια στήλης ταξινομούμε
     * @param arr
     */
    ...
    /**
     * Προσθέτει τις αφίξεις και αφαιρεί για αναχωρήσεις και κάθε
     * φορά συγκρίνει το count με το maxCount και επιστρέφει maxCount
     * @param arr
     * @return
     */
